...
inp = struct( ...
    ...
    'out_dir', '../../OUTPUTS', ...
    'eprime_csv', '../../OUTPUTS/eprime.csv', ...
    'wfmri1_nii', '../../OUTPUTS/wctrrfmri1.nii', ...
    'wfmri2_nii', '../../OUTPUTS/wctrrfmri2.nii', ...
    'wfmri3_nii', '../../OUTPUTS/wctrrfmri3.nii', ...
    'wfmri4_nii', '../../OUTPUTS/wctrrfmri4.nii', ...
    'biasnorm_nii', '../../OUTPUTS/biasnorm.nii' ...
    );

first_level_stats_hct_unsmoothed(inp);
